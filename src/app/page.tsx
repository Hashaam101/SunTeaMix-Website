            ...
            <div className="col-span-2 lg:col-span-1 mx-auto flex flex-row items-center lg:items-start gap-4">
              ...
              <div className="flex h-[120px] justify-evenly gap-[10px] flex-col my-auto max-w-100">
                <a
                  ...
                  className="bg-black/[0.2] min-w-[100px] p-2 py-4 h-full w-full items-center justify-center flex rounded-lg group transition-all hover:bg-black/[0.15]"
                >
                  <svg
                ...
                <a
                  ...
                  aria-label="Yelp"
                  className="bg-black/[0.2] p-2 py-4 h-full w-full items-center justify-center flex rounded-lg group transition-all hover:bg-black/[0.15]"
                >
