...
function Featuring() {
  ...
  return (
    <div className='w-full'>
      <motion.div
        className='mx-auto w-full max-w-[1000px] px-4 md:px-0'
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, amount: 0.15 }}
        variants={sectionVariants}
      >
        <div className='mb-12 text-center text-h2 text-black md:mb-[80px]'>
          <div className=''>Featuring</div>
          <div className='mx-2x mt-1 text-normal2 sm:text-h5'>Food that’s Healthy AND Satisfies Your Cravings</div>
        </div>

        <div className='group grid grid-cols-2 gap-x-4 gap-y-8 self-stretch md:flex md:items-center md:justify-between md:gap-0'>
          <div className='flex w-full flex-col items-center gap-[10px]'>
            <div className='aspect-square h-[22px] w-[22px] text-grey'>
            ...
            <div className='text-center text-normal3'>Fluffy Soufflé Pancakes</div>
          </div>
          <div className='hidden h-[80px] w-[1px] bg-black transition-all duration-300 group-hover:rotate-8 md:block'></div>
          <div className='flex w-full flex-col items-center gap-[10px]'>
            <div className='aspect-square h-[22px] w-[22px] text-grey'>
            ...
            <div className='text-center text-normal3'>Smoothies & Yogurt Drinks</div>
          </div>
          ...
          <div className='flex w-full flex-col items-center gap-[10px]'>
            ...
            <div className='text-center text-normal3'>Delivery & Takeaway Options</div>
          </div>
          <div className='hidden h-[80px] w-[1px] bg-black transition-all duration-300 group-hover:rotate-8 md:block'></div>
          <div className='flex w-full flex-col items-center gap-[10px]'>
            <div className='aspect-square h-[22px] w-[22px] text-grey'>
            ...
            <div className='text-center text-normal3'>Easy Parking</div>
          </div>
        </div>
      </motion.div>
      ...
      <div className='mb-12 text-center text-h2 text-black md:mb-[80px]'>
        ...
        <div className='mx-2x mt-1 text-normal2 sm:text-h5'>Recommended Sample Text Placeholder</div>
      </div>
      ...
      >
        <div className='mx-auto flex w-full max-w-[1240px] flex-col items-center gap-8 lg:flex-row lg:justify-between lg:gap-0'>
          ...
          <div className='mt-8 flex w-full max-w-[560px] flex-col items-center gap-[10px] md:gap-[20px] lg:mt-0 lg:w-fit lg:items-start lg:pl-8'>
            <div className='self-stretch text-center text-h3 text-black lg:text-left xl:text-h2'>
              Bubble Tea & Boba Drinks
            </div>
            <div className='text-center text-normal4 text-grey md:text-normal3 lg:text-left'>
      ...
      >
        <div className='mx-auto flex w-full max-w-[1240px] flex-col items-center gap-8 lg:flex-row lg:justify-between lg:gap-0'>
          ...
          <div className='mt-8 flex w-full max-w-[560px] flex-col items-center gap-[10px] md:gap-[20px] lg:mt-0 lg:w-fit lg:items-start lg:pr-16'>
            <div className='self-stretch text-center text-h3 text-black lg:text-left lg:text-h2 xl:text-h2'>
              Soufflé Pancakes
            </div>
            <div className='text-center text-normal4 text-grey md:text-normal3 lg:text-left'>
